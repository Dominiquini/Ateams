...
CXX_FLAGS = {"RELEASE": f"{CXX_GLOBAL_FLAGS} -O3 -flto -ffast-math", "DEBUG": f"{CXX_GLOBAL_FLAGS} -O0 -fno-lto -g3 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer", "PROFILE": f"{CXX_GLOBAL_FLAGS} -O0 -fno-lto -g3 -pg -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer"}
