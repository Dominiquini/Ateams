...
list<Problem*>* Problem::readPopulationFromLog(char *log) {
	...
	if (f != NULL) {
		...
		for (int i = 0; i < npop; i++) {
			ordem = (short int*) allocateMatrix<short int>(1, nnodes);
...
GraphColoring::GraphColoring() : Problem::Problem() {
	solution.ordemNodes = (short int*) allocateMatrix<short int>(1, nnodes);
...
GraphColoring::GraphColoring(const Problem &prob) : Problem::Problem() {
	...
	this->solution.ordemNodes = (short int*) allocateMatrix<short int>(1, nnodes);
	...
	if (other->solution.colors != NULL) {
		this->solution.colors = (short int*) allocateMatrix<short int>(1, nnodes + 1);
...
GraphColoring::~GraphColoring() {
	...
	deallocateMatrix<short int>(1, solution.colors);
}
...
inline bool GraphColoring::calcFitness() {
	...
	short int *aux_colors = (short int*) allocateMatrix<short int>(1, nnodes + 1);
...
inline pair<Problem*, Problem*>* GraphColoring::crossOver(const Problem *parceiro, int partitionSize, int strength) {
	short int *f1 = (short int*) allocateMatrix<short int>(1, nnodes), *f2 = (short int*) allocateMatrix<short int>(1, nnodes);
...
inline Problem* GraphColoring::mutation(int mutMax) {
	short int *mut = (short int*) allocateMatrix<short int>(1, nnodes);
